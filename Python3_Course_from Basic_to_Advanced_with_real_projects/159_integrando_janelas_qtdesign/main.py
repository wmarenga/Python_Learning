"""
Convertendo o design em arquivo Python (Linux):
>> pyuic5 design.ui -o design.py

Convertendo em Windows:
>> python -m PyQt5.uic.pyuic -x 159_integrando_janelas_qtdesign/design.ui -o 159_integrando_janelas_qtdesign/design.py
"""
