...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        # linha = 0, coluna = 0, utiliza 1 linha, ocupa 5 colunas
        self.grid.addWidget(self.display, 0, 0, 1, 5)
        self.display.setDisabled(True)  # Desativa a digitação do campo display
        self.display.setStyleSheet(
            '* {background: black; color: #ccff33; font-size: 30px}'
        )
