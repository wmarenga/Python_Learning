...
# Instâncias/Objetos
lamp1 = Lampada('branca', 110, 60)  # O self é o próprio objeto (lamp1)

lamp1.ligar_desligar()  # Altera para lâmpada ligada (True)
lamp1.ligar_desligar()  # Altera para lâmpada desligada (False)

print(f'A lâmpada está ligada? {lamp1.checa_lampada()}')


cc1 = ContaCorrente(5000, 20000, 'Wellington')
...
cc._ContaCorrente__cliente.diz()  # Acesso errado.
