...
Existe alguma entidade genérica o suciente para encapsular os
...
class Cliente(Pessoa): # A herança está entre chaves (Pessoa)
...
class Funcionario(Pessoa): # A herança está entre chaves (Pessoa)
