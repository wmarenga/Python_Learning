...
# Estamos herdando diretamente de Aquatico e Terrestre e indiretamente
# de Animal.


# Se inserírmos a herança Terrestre primeiro irá mostrar (Eu sou Tux da terra!)
# Se inserírmos a herança Aquatico primeiro irá mostrar (Eu sou Tux do mar!)
...
print(tux.andar())
print(tux.nadar())
# Eu sou Tux da terra! / Eu sou Tux do mar! ???? Method Resolution Order - MRO
