...
# 'wb' => escreve em arquivo binário
with open('132) Conhecendo o Pickle/animais.pickle', 'wb') as arquivo:
...
# 'rb' => Leitura binária
with open('132) Conhecendo o Pickle/animais.pickle', 'rb') as arquivo:
