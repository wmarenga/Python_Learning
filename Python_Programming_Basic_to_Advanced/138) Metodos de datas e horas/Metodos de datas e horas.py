...
Documentação:
https://docs.python.org/pt-br/3/library/datetime.html?highlight=timezone#datetime.datetime.tzname
...
hoje_formatado = hoje.strftime('%d/%m/%Y') # Ano completo com 4 dígitos
hoje_formatado = hoje.strftime('%d/%m/%y') # Ano abreviado com 2 dígitos
hoje_formatado = hoje.strftime('%d/%B/%y') # Mostra o nome do mês (completo) em inglês
hoje_formatado = hoje.strftime('%d/%b/%y') # Mostra o nome do mês (iniciais) em inglês

print(hoje_formatado)

# Mostra o nome do mês (completo) em inglês
...
# python -m pip install textblob (virtualenv)
...
# Transformando a string em objeto do tipo datetime
...
# O timeit recebe dois parâmetros (função que queremos executar, repetições)
...
# functools.partial(teste, 2) => (nome da função, parâmetro de entrada da função)
"""
