...
# OBS: A palavra 'assert' pode ser utilizada em qualquer função ou código
...
# Seria o mesmo que utilizar um if:

def soma_numeros_positivos(a, b):
    if a > 0 and b > 0:
        return a + b
    else:
        'Ambos números precisam ser positivos'
...
Se um programa Python for executado com o parâmetro -O (python -O assertions.py),
