...
Teste é a forma de se testar unidades individuais de código fonte (menor
unidade de código).
...
Para rodar os testes, utilizamos:
unittest.main()
...
python 144_Introducao_ao_modulo_unittest/testes (Professor).py -v
