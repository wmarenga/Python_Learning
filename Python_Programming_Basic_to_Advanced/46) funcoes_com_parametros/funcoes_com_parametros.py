...
print(quadrado()) # TypeError: quadrado() missing 1 required positional
argument: 'numero'
...
# Funcoes podem ter n parametros de entrada, ou seja, podemos receber como
# entrada em uma funcao quantos parametros forem necessarios. Eles sao
...
# nome e sobrenome sao parametros para receber argumentos
    return f'Seu nome completo e {nome} {sobrenome}'

print(nome_completo('Angelina', "Jolie"))
# Sao argumentos os dados que a funcao vai receber
