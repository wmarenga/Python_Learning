"""
29. Codifique um programa que manipule um arquivo contendo registros descritos pelos 
seguintes campos: codigo_vendedor, nome_vendedor, valor_da_venda e mes.
A manipulação do arquivo em questão é feita através da execução das operações
...
informações contidas nos campos codigo_vendedor e mes. Não deve existir mais de um
registro no arquivo com mesmos valores nos campos codigo_vendedor e mês.
"""
