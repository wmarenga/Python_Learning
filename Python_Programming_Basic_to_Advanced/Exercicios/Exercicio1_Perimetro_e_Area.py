...
# correspondente ao lado de um quadrado, calcule e imprima (saída de
# dados) seu perímetro e sua área.
...
# Dica: lembre-se que um quadrado tem quatro lados iguais, logo só é
# necessário pedir o lado uma vez.
