...
" Criamos uma nova variavel df_juncao para guardar o novo df(unido)"
df_juncao = dfvendas.join(dfclientes.add_prefix('clientes_'), on='id_cliente')
print(df_juncao.columns)
print(df_juncao)

" Precisamos unir as informacoes do dflojas em df_juncao "
df_juncao = df_juncao.join(dflojas.add_prefix('lojas_'), on='id_loja')
print(df_juncao)

" Precisamos tambem unir as informacoes do dfprodutos em df_juncao "
...
" Avaliando se existe algum dado nulo ou em branco "
