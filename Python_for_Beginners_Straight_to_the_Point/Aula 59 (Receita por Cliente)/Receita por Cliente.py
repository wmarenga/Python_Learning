...
caminho_arquivo_Excel ='D:/23) Programação/Cursos/Python/4) Python para Iniciantes (Direto ao que interessa)/Aula 59 (Receita por Cliente)/caso_estudo.xlsx'
...
" Definindo o formato do segundo grafico (ax2) no eixo y em percentagem "
