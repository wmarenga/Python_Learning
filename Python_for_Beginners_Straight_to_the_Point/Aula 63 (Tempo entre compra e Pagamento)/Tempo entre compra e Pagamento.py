...
caminho_arquivo_Excel ='D:/23) Programação/Cursos/Python/4) Python para Iniciantes (Direto ao que interessa)/Aula 63 (Tempo entre compra e Pagamento)/caso_estudo.xlsx'
