...
caminho_arquivo_Excel ='D:/23) Programação/Cursos/Python/4) Python para Iniciantes (Direto ao que interessa)/Aula 64 (Tempo de pagamento por cidade e produto)/caso_estudo.xlsx'
